...
public class RPyromane extends Role {
	...
	protected static final String COVERED_IN_GASOLINE_MESSAGE = "§6Tu es recouvert de gasoil...";
	protected static final String COVERED_IN_GASOLINE = "pyromane_essence";
